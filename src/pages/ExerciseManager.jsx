  ...
  return (
    <div style={{ width: "100%", padding: "16px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
        <h2 style={{ margin: 0, color: "#222", fontFamily: "'Playfair Display', Georgia, serif" }}>Exercise Library</h2>
        <button onClick={openAddModal} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 20px", backgroundColor: "#15213f", color: "white", border: "none", borderRadius: "8px", fontWeight: "700", cursor: "pointer" }}>
          <Plus size={20} />
          Add New Exercise
        </button>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "16px" }}>
        {exercises.map((exercise) => {
          ...
          return (
            <div key={id} style={{ backgroundColor: isSelected ? "#eef1f7" : "#ffffff", border: isSelected ? "2px solid #15213f" : "1.5px solid #e8e8e8", borderRadius: "12px", overflow: "hidden", position: "relative", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
              <div style={{ height: "130px", backgroundColor: "#f4f6f9", position: "relative" }}>
                ...
                {isSelected && (
                  <div style={{ position: "absolute", top: "8px", left: "8px", backgroundColor: "#15213f", borderRadius: "50%", padding: "2px" }}>
              ...
              <div style={{ padding: "12px", cursor: "pointer" }} onClick={() => toggleExercise(id)}>
                ...
                <div style={{ fontSize: "12px", color: "#15213f", marginBottom: "8px" }}>{exercise.category}</div>
      ...
      {selected.length > 0 && (
        <div style={{ marginTop: "32px", textAlign: "center" }}>
          <button onClick={handleSaveWorkout} style={{ backgroundColor: "#15213f", color: "white", border: "none", padding: "12px 28px", borderRadius: "8px", fontWeight: "700", fontSize: "16px", display: "inline-flex", alignItems: "center", gap: "10px" }}>
            <Dumbbell size={20} />
          ...
          <div style={{ background: "white", borderRadius: "12px", width: "90%", maxWidth: "520px", maxHeight: "92vh", overflow: "auto" }} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} style={{ padding: "24px" }}>
              ...
              <div style={{ display: "flex", gap: "12px" }}>
                ...
                <button type="submit" style={{ flex: 1, padding: "12px", backgroundColor: "#15213f", color: "white", border: "none", borderRadius: "8px", fontWeight: "700" }}>
